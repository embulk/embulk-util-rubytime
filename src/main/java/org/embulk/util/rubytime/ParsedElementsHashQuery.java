...
public class ParsedElementsHashQuery<T> implements TemporalQuery<Map<T, Object>> {
    ...
    private ParsedElementsHashQuery(
    ...
    public static ParsedElementsHashQuery<String> withFractionInBigDecimal() {
        return new ParsedElementsHashQuery<String>(FRACTION_TO_BIG_DECIMAL, STRING_AS_IS);
    }

    public static ParsedElementsHashQuery<String> of(final FractionConverter fractionConverter) {
        return new ParsedElementsHashQuery<String>(fractionConverter, STRING_AS_IS);
    }

    public static <U> ParsedElementsHashQuery<U> of(
            final FractionConverter fractionConverter,
            final HashKeyConverter<U> hashKeyConverter) {
        return new ParsedElementsHashQuery<U>(fractionConverter, hashKeyConverter);
    }
